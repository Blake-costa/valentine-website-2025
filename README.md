...
```javascript
// Basic Information
valentineName: "Kiana"                    // Your Valentine's name
...
// Final Celebration
celebration: {
    title: "Yay! I'm the luckiest person in the world",     // Celebration title
    message: "Now come get your gift, hint: it rhyms with ping and stars with a R ;)",          // Celebration message
